...
EXT void NF_sourceid_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
...
EXT void SF_sourceid_handler(struct channels_list_entry *, struct packet_ptrs *, char **);
